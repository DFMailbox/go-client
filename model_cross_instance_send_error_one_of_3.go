...
// checks if the CrossInstanceSendErrorOneOf3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CrossInstanceSendErrorOneOf3{}

// CrossInstanceSendErrorOneOf3 struct for CrossInstanceSendErrorOneOf3
type CrossInstanceSendErrorOneOf3 struct {
...
type _CrossInstanceSendErrorOneOf3 CrossInstanceSendErrorOneOf3
...
func NewCrossInstanceSendErrorOneOf3(type_ interface{}, title interface{}, status int32, details string, sender int32) *CrossInstanceSendErrorOneOf3 {
	this := CrossInstanceSendErrorOneOf3{}
	this.Type = type_
	this.Title = title
	this.Status = status
...
// SetReceiver gets a reference to the given int32 and assigns it to the Receiver field.
func (o *CrossInstanceSendErrorOneOf3) SetReceiver(v int32) {
	o.Receiver = &v
}

func (o CrossInstanceSendErrorOneOf3) MarshalJSON() ([]byte, error) {
...
func (o CrossInstanceSendErrorOneOf3) ToMap() (map[string]interface{}, error) {
...
func (o *CrossInstanceSendErrorOneOf3) UnmarshalJSON(data []byte) (err error) {
	...
	varCrossInstanceSendErrorOneOf3 := _CrossInstanceSendErrorOneOf3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCrossInstanceSendErrorOneOf3)

	if err != nil {
		return err
	}

	*o = CrossInstanceSendErrorOneOf3(varCrossInstanceSendErrorOneOf3)

	return err
}

type NullableCrossInstanceSendErrorOneOf3 struct {
	value *CrossInstanceSendErrorOneOf3
	isSet bool
}

func (v NullableCrossInstanceSendErrorOneOf3) Get() *CrossInstanceSendErrorOneOf3 {
	return v.value
}

func (v *NullableCrossInstanceSendErrorOneOf3) Set(val *CrossInstanceSendErrorOneOf3) {
	v.value = val
	v.isSet = true
}

func (v NullableCrossInstanceSendErrorOneOf3) IsSet() bool {
	return v.isSet
}

func (v *NullableCrossInstanceSendErrorOneOf3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCrossInstanceSendErrorOneOf3(val *CrossInstanceSendErrorOneOf3) *NullableCrossInstanceSendErrorOneOf3 {
	return &NullableCrossInstanceSendErrorOneOf3{value: val, isSet: true}
}

func (v NullableCrossInstanceSendErrorOneOf3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCrossInstanceSendErrorOneOf3) UnmarshalJSON(src []byte) error {
	v.isSet = true
