...
type InlineObject5 struct {
	...
	InlineObject5OneOf2 *InlineObject5OneOf2
...
// InlineObject5OneOf2AsInlineObject5 is a convenience function that returns InlineObject5OneOf2 wrapped in InlineObject5
func InlineObject5OneOf2AsInlineObject5(v *InlineObject5OneOf2) InlineObject5 {
	return InlineObject5{
		InlineObject5OneOf2: v,
	}
}
...
func (dst *InlineObject5) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into InlineObject5OneOf2
	err = newStrictDecoder(data).Decode(&dst.InlineObject5OneOf2)
	if err == nil {
		jsonInlineObject5OneOf2, _ := json.Marshal(dst.InlineObject5OneOf2)
		if string(jsonInlineObject5OneOf2) == "{}" { // empty struct
			dst.InlineObject5OneOf2 = nil
		} else {
			if err = validator.Validate(dst.InlineObject5OneOf2); err != nil {
				dst.InlineObject5OneOf2 = nil
			} else {
				match++
			}
...
func (src InlineObject5) MarshalJSON() ([]byte, error) {
	...
	if src.InlineObject5OneOf2 != nil {
		return json.Marshal(&src.InlineObject5OneOf2)
	}
...
func (obj *InlineObject5) GetActualInstance() (interface{}) {
	...
	if obj.InlineObject5OneOf2 != nil {
		return obj.InlineObject5OneOf2
	}
